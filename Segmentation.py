...
#    plt.colorbar(ax1, ax=ax[1])
    ...
    ax[2].set_title('Clustering',fontsize=15)
    for a in ax:
        a.axis('off')
    plt.tight_layout()
    plt.show()
...
#    ax.axis('off')
#    plt.tight_layout()
#    plt.savefig('logs/overseg.pdf', bbox_inches = 'tight', pad_inches = 0)
#    plt.show()
...
#    ax.axis('off')
#    plt.tight_layout()
#    plt.savefig('logs/seg_original.pdf', bbox_inches = 'tight', pad_inches = 0)
#    plt.show()
#    
...
#    ax.axis('off')
#    plt.tight_layout()
#    plt.savefig('logs/seg_rag.pdf', bbox_inches = 'tight', pad_inches = 0)
#    plt.show()
...
#    ax.set_title('Segmentation',fontsize=15)
    ax.axis('off')
    plt.tight_layout()
#    plt.savefig('logs/seg_diffpool.pdf', bbox_inches = 'tight', pad_inches = 0)
    plt.show()
